    ...
    const navigateToEvents = () => {
     ...
     return (
         ...
         <div style={styles.lime}  className="ui stackable one column grid menu center">
             <h1 className=''>Soccer Events</h1>
             <div></div>
             <button className='ui left labeled icon black button' style={styles.bord} onClick={navigateToEvents}> <i class="backward icon"></i>Back</button>
   <div></div>
   <button className='ui right labeled icon button black' style={styles.bord} onClick={navigateToAddEvent}> <i className="forward icon"></i>New Event</button>
