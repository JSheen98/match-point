...
const Other = () => {
 ...
 const other = [
    'Bowling', 'Boxing', 'Disc Golf', 'Golf', 'Hockey', 'Lacrosse', 'Pickleball', 'Racquetball', 'Rugbee', 'Softball', 'Tennis', 'Volleyball', 'Underwater Basketweaving', 'Other'
 ]
   ...
   <button className='ui right labeled icon button' onclick="/"> <i className="forward icon"></i>New Event</button>
             ...
             {eventData.filter((EventListItem) => {
                 ...
                 if(EventListItem.sport === 'Other' || EventListItem.sport === 'Underwater Basketweaving' || EventListItem.sport === 'Tennis' || EventListItem.sport === 'Softball' || EventListItem.sport === 'Rugbee' || EventListItem.sport === 'Racquetball' || EventListItem.sport === 'Pickleball' || EventListItem.sport === 'Lacrosse' || EventListItem.sport === 'Hockey' || EventListItem.sport === 'Boxing' || EventListItem.sport === 'Disc Golf' || EventListItem.sport === 'Volleyball' || EventListItem.sport === 'Bowling' || EventListItem.sport === 'Golf' ) {
                 return (
